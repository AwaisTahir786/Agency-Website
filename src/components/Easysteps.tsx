...
const Easysteps = () => {
  return (
    <div className="h-full min-h-screen w-full bg-black pt-12 p-4">
      <div
          className="text-4xl font-bold md:text-4xl px-6 text-center bg-clip-text text-[#39FF14] "
        >
         A professional logo in
three easy steps
