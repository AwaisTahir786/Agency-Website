...
<section className="bg-white mt-10 md:py-0 ">
  ...
  <div className='text-4xl py-10 md:pb-4 md:text-7xl text-center bg-clip-text text-black'>
      ...
      <div className="mx-auto max-w-screen-lg text-lg text-center mb-8 lg:mb-16">
          <h2 className="  text-gray-900 dark:text-white">We have worked with thousands of amazing peoples</h2>
      </div> 
      ...
      <div className="container mx-auto mb-10 lg:px-10">
        <div className="grid gap-6 max-w-screen px-40 lg:grid-cols-2 xl:grid-cols-3">
            ...
            <div className="flex flex-col justify-between w-full h-[20rem]	 px-6 py-6 bg-gray-100 dark:bg-gray-800 md:px-10 rounded-2xl md:py-10   dark:bg-trueGray-800">
                    <p className="text-xl leading-normal">Share a<mark className="mx-1 text-indigo-800 bg-indigo-100 rounded-md ring-indigo-100 ring-4 dark:ring-indigo-900 dark:bg-indigo-900 dark:text-indigo-200">testimonial</mark>that hits some of your benefits from one of your popular customer.</p>
                    <div className="flex items-center mt-8 space-x-3">
                        ...
                        <div>
                            ...
                            <div className="text-gray-600 text-sm dark:text-gray-400">VP Sales at Google</div>
                        </div>
                    </div>
                </div>
            </div>
            <div className="">
            <div className="flex flex-col justify-between w-full h-[20rem]	 px-6 py-6 bg-gray-100 dark:bg-gray-800 md:px-10 rounded-2xl md:py-10   dark:bg-trueGray-800">
                    <p className="text-xl leading-normal">Make sure you only pick the <mark className="mx-1 text-indigo-800 bg-indigo-100 rounded-md ring-indigo-100 ring-4 dark:ring-indigo-900 dark:bg-indigo-900 dark:text-indigo-200">right sentence</mark> to keep it short and simple.</p>
                    <div className="flex items-center mt-8 space-x-3">
                        <div className="flex-shrink-0 overflow-hidden rounded-full w-14 h-14">
                        ...
                        <div>
                            ...
                            <div className="text-gray-600 text-sm dark:text-gray-400">Lead marketer at Netflix </div>
                        </div>
                    </div>
                </div>
            </div>
            <div className="">
            <div className="flex flex-col justify-between w-full h-[20rem]	 px-6 py-6 bg-gray-100 dark:bg-gray-800 md:px-10 rounded-2xl md:py-10   dark:bg-trueGray-800">
                    <p className="text-xl leading-normal">This is an <mark className="mx-1 text-indigo-800 bg-indigo-100 rounded-md ring-indigo-100 ring-4 dark:ring-indigo-900 dark:bg-indigo-900 dark:text-indigo-200">awesome</mark> landing page template I&#x27;ve seen. I would use this for anything.</p>
                    <div className="flex items-center mt-8 space-x-3">
                        <div className="flex-shrink-0 overflow-hidden rounded-full w-14 h-14">
                        ...
                        <div>
                            ...
                            <div className="text-gray-600 text-sm dark:text-gray-400">Co-founder of Acme Inc</div>
                        </div>
                    </div>
                </div>
            </div>
