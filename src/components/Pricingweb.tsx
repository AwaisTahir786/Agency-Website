...
const plans = [
  {
    ...
    description:
      "Standalone components  integrated. Perfect for website elements or sections.",
    button: "Buy Now",
  },
  {
    index: 1,
    ...
    style:
      " rounded-3xl  py-10 bg-clip-text text-transparent bg-gradient-to-b from-neutral-300 to-neutral-50",
    description:
      "Best for early-stage startups, businesses, to showcase their work and vision.",
    button: "Buy Now",
  },
  {
    index: 2,
     ...
     bg-grid-white/[0.02] relative overflow-hidden">
      ...
      <div className="flex items-center justify-center flex-col">
        <div className="text-5xl pb-10 md:pb-20 text-[#39FF14] px-6 text-center bg-clip-text  bg-gradient-to-b from-neutral-50 to-neutral-500 bg-opacity-50">
          Simple Pricing <br /> For Logo Designing
        </div>
        <div className="grid md:grid-cols-3 gap-6 md:w-[90%] cursor-pointer pb-6  items-start ">
          {plans.map((plan, index) => (
            <div
              key={plan.name}
              className="h-[41em] flex flex-col justify-between  border-2 rounded-3xl px-6  "
            >
